...
dependencies {
  ...
  implementation(files("../Imports/dotutils-0.0.1-SNAPSHOT.jar"))
...
bukkit {
  main = "net.dotefekts.playerprofile.PlayerProfile"
  apiVersion = "1.18"
  authors = listOf("DotEfekts")
  depend = listOf("DotUtilities")
}
